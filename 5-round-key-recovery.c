...
///////////////////////////////////////////////////////////////////////////////////////////////
void keyrecovery(word8 key[][8]){
	int i,j,k,diff,diff1,r,flag;
	word8 c[4][4][4];
	word8 p[4][4][4];
	word8 rp[4][4],rp1[4][4],rp2[4][4],rp3[4][4],rkey[2];
	...
	rkey[0]=key[0][0]^key[1][1];
	rkey[1]=key[0][0]^key[2][2];
	...
	if(plain[0][0]!=plain1[0][0]){
		for(diff=0;diff<256;diff++){
			for(diff1=0;diff1<256;diff1++){
			
				plain[256*diff+diff1][0]=plain[0][0];
				plain1[256*diff+diff1][0]=plain1[0][0];
				
				plain[256*diff+diff1][5]=plain[0][0]^diff;
				plain1[256*diff+diff1][5]=plain1[0][0]^ diff;
				
				plain[256*diff+diff1][10]=plain[0][0]^diff1;
				plain1[256*diff+diff1][10]=plain1[0][0]^ diff1;
				
				for(i=0; i<4 ;i++)
					for(j=0; j<4 ;j++)
						temp[i][j]=plain[256*diff+diff1][4*i+j];
				for(i=0; i<4 ;i++)
					for(j=0; j<4 ;j++)
						temp1[i][j]=plain1[256*diff+diff1][4*i+j];
				...
				for(i=0; i<4 ;i++)
					for(j=0; j<4 ;j++)
						cipher[256*diff+diff1][4*i+j]= temp[i][j];
				for(i=0; i<4 ;i++)
					for(j=0; j<4 ;j++)
						cipher[256*diff+diff1][4*i+j]= temp1[i][j];
